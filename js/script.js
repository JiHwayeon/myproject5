 ...
 */
 $(function(){
  ...
  $("#modal-open100").click(function(){   $("#popup02").css('display','flex').hide().fadeIn();
  });
  $("#close02").click(function(){
      modalClose();
  });
...
$(function(){
  ...
  $("#modal-open200").click(function(){   $("#popup02").css('display','flex').hide().fadeIn();
  });
  $("#close02").click(function(){
      modalClose();
  });
...
$(window).scroll(function(){
  ...
  if(scrT == $(document).height() - $(window).height()){
    $("#result-munu-bar").css({'bottom':'90px'});
    $("#footer").css({'display':'block'});
    
  	//스크롤이 끝에 도달했을때 실행될 이벤트
  } else {
    $("#result-munu-bar").css({'bottom':'0'});
